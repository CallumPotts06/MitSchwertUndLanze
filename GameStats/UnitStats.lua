...
UnitStats.GermanUnits.PrussianLineInfantry.FireRate = 8 -- 1 / X chance to fire --
UnitStats.GermanUnits.PrussianLineInfantry.MarchSpeed = 4
...
UnitStats.GermanUnits.HessianLineInfantry.FireRate = 8 -- 1 / X chance to fire --
UnitStats.GermanUnits.HessianLineInfantry.MarchSpeed = 4
...
UnitStats.GermanUnits.SaxonLineInfantry.FireRate = 8 -- 1 / X chance to fire --
UnitStats.GermanUnits.SaxonLineInfantry.MarchSpeed = 4
...
UnitStats.GermanUnits.BadenLineInfantry.FireRate = 8 -- 1 / X chance to fire --
UnitStats.GermanUnits.BadenLineInfantry.MarchSpeed = 4
...
UnitStats.GermanUnits.WuerttemburgLineInfantry.FireRate = 8 -- 1 / X chance to fire --
UnitStats.GermanUnits.WuerttemburgLineInfantry.MarchSpeed = 4
...
UnitStats.GermanUnits.PrussianGuards.FireRate = 7 -- 1 / X chance to fire --
UnitStats.GermanUnits.PrussianGuards.MarchSpeed = 5
...
UnitStats.GermanUnits.PrussianJaegers.FireRate = 8 -- 1 / X chance to fire --
...
UnitStats.GermanUnits.Landwehr.FireRate = 9 -- 1 / X chance to fire --
UnitStats.GermanUnits.Landwehr.MarchSpeed = 3
...
UnitStats.GermanUnits.BayerischerLineInfantry.FireRate = 8 -- 1 / X chance to fire --
UnitStats.GermanUnits.BayerischerLineInfantry.MarchSpeed = 4
...
UnitStats.GermanUnits.Artillery.Damage = 9
UnitStats.GermanUnits.Artillery.Accuracy = 5/10
UnitStats.GermanUnits.Artillery.MaxRange = 9000
UnitStats.GermanUnits.Artillery.FireRate = 50 -- 1 / X chance to fire --
UnitStats.GermanUnits.Artillery.MarchSpeed = 4
...
UnitStats.FrenchUnits.FrenchLineInfantry.FireRate = 8 -- 1 / X chance to fire --
UnitStats.FrenchUnits.FrenchLineInfantry.MarchSpeed = 4
...
UnitStats.FrenchUnits.FrenchZouaves.FireRate = 8 -- 1 / X chance to fire --
...
UnitStats.FrenchUnits.FrenchChasseurs.FireRate = 8 -- 1 / X chance to fire --
...
UnitStats.FrenchUnits.Artillery.Damage = 8
UnitStats.FrenchUnits.Artillery.Accuracy = 5/10
UnitStats.FrenchUnits.Artillery.MaxRange = 9000
UnitStats.FrenchUnits.Artillery.FireRate = 80 -- 1 / X chance to fire --
UnitStats.FrenchUnits.Artillery.MarchSpeed = 4
