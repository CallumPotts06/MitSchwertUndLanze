...
---/// #################### ///---
Textures = {}
Textures.Grass = love.graphics.newImage("Assets/Images/MapTextures/GrassTexture.png")
Textures.Forest = love.graphics.newImage("Assets/Images/MapTextures/ForestTexture.png")
Textures.Water = love.graphics.newImage("Assets/Images/MapTextures/BlueWaterTexture.png")
Textures.Sand = love.graphics.newImage("Assets/Images/MapTextures/SandTexture.png")
Textures.MudPath = love.graphics.newImage("Assets/Images/MapTextures/Path.png")
Textures.StonePath = love.graphics.newImage("Assets/Images/MapTextures/Path.png")
Textures.Road = love.graphics.newImage("Assets/Images/MapTextures/Road.png")
Textures.Farmland = love.graphics.newImage("Assets/Images/MapTextures/Farmland.png")
