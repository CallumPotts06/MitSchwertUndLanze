...
function SettingsMenu.Open()
    ...
    bx1 = TextBox.New("SoundSettingsHeader",txt1,soundPos,headerSize,5,10,btnFont,1,black,white,lgray,false,false)
    bx2a = TextBox.New("VolumeTxt",txt2,btn2aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx2b = TextBox.New("VolumeBtn",txt2b,btn2bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)
    bx3a = TextBox.New("MenuMusicTxt",txt3,btn3aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx3b = TextBox.New("MenuMusicBtn",txt3b,btn3bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)

    bx4 = TextBox.New("VideoSettingsHeader",txt4,videoPos,headerSize,5,10,btnFont,1,black,white,lgray,false,false)
    bx5a = TextBox.New("FullScreenTxt",txt5,btn5aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx5b = TextBox.New("FullScreenBtn",txt5b,btn5bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)
    bx6a = TextBox.New("WidthTxt",txt6,btn6aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx6b = TextBox.New("WidthBtn",txt6b,btn6bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)
    bx7a = TextBox.New("HeightTxt",txt7,btn7aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx7b = TextBox.New("HeightBtn",txt7b,btn7bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)
    bx8a = TextBox.New("WeatherTxt",txt8,btn8aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx8b = TextBox.New("WeatherBtn",txt8b,btn8bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)

    bx9 = TextBox.New("KeyBindsHeader",txt9,keyPos,headerSize,5,10,btnFont,1,black,white,lgray,false,false)
    bx10a = TextBox.New("MoveTxt",txt10,btn10aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx10b = TextBox.New("MoveBtn",txt10b,btn10bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)
    bx11a = TextBox.New("WheelTxt",txt11,btn11aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx11b = TextBox.New("WheelBtn",txt11b,btn11bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)
    bx12a = TextBox.New("ChargeTxt",txt12,btn12aPos,btnSize,5,10,btnFont,0.95,black,textBackClr,transparent,false,false)
    bx12b = TextBox.New("ChargeBtn",txt12b,btn12bPos,etrSize,5,10,btnFont,0.9,white,textBackClr,transparent,true,true)
